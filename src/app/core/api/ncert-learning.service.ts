...
export class NcertLearningService {
  ...
  getClasses(): Observable<string[]> {
    return this.http.get<string[]>(`${this.baseUrl}/api/classes`).pipe(
  ...
  getSubjectsByClass(classId: string): Observable<string[]> {
    return this.http.get<string[]>(`${this.baseUrl}/api/classes/${classId}/subjects`).pipe(
  ...
  getBooksBySubject(subjectId: string): Observable<NcertBook[]> {
    return this.http.get<NcertBook[]>(`${this.baseUrl}/api/subjects/${subjectId}/books`).pipe(
  ...
  getChaptersByBook(bookId: number): Observable<NcertChapter[]> {
    return this.http.get<NcertChapter[]>(`${this.baseUrl}/api/books/${bookId}/chapters`).pipe(
  ...
  getBookPdfUrl(bookId: number): Observable<{ url: string }> {
    return this.http.get<{ url: string }>(`${this.baseUrl}/api/books/${bookId}/pdf`).pipe(
  ...
  getChapterContent(chapterId: number): Observable<ContentBlock[]> {
    return this.http.get<ContentBlock[]>(`${this.baseUrl}/api/chapters/${chapterId}/content`).pipe(
  ...
  uploadPdf(request: BookUploadRequest): Observable<{ message: string; bookId: string }> {
    return this.http.post<{ message: string; bookId: string }>(`${this.baseUrl}/api/books/upload`, request).pipe(
  ...
  generateQuiz(request: QuizRequest): Observable<QuizQuestion[]> {
    return this.http.post<QuizQuestion[]>(`${this.baseUrl}/api/quiz/generate`, request).pipe(
  ...
  askQuestion(request: QuestionRequest): Observable<QuestionResponse> {
    return this.http.post<QuestionResponse>(`${this.baseUrl}/api/ask`, request).pipe(
      catchError(() => of({ 
  ...
  getVisualization(conceptId: string, classLevel: number, subject: string): Observable<VisualizationData> {
    ...
    return this.http.get<VisualizationData>(`${this.baseUrl}/api/concepts/${conceptId}/visual`, { params }).pipe(
